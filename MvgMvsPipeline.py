    ...
    def __init__(self):
        self.steps_data = [
            ...
            [
                ...
                [
                    "-i",
                    "%matches_dir%" + FOLDER_DELIM + "sfm_data.json",
                    "-o",
                    "%matches_dir%",
                    "-m",
                    "SUPERPOINT",
            ...
            [
                ...
                [
                    ...
                    "%matches_dir%" + FOLDER_DELIM + "pairs.bin",
                    "-o",
                    "%matches_dir%" + FOLDER_DELIM + "matches.putative.bin",
                    "-n",
                    "LIGHTGLUE",
                    "-r",
                    "0.4",
            ...
            [
                ...
                [
                    ...
                    "%matches_dir%" + FOLDER_DELIM + "matches.putative.bin",
                    "-o",
                    "%matches_dir%" + FOLDER_DELIM + "matches.f.bin",
                ],
            ],
            [
            ...
            [
                ...
                [
                    ...
                    "GLOBAL",
                    "-M",
                    "%matches_dir%" + FOLDER_DELIM + "matches.e.bin",
                ],
            ],
            [
                ...
                [
                    "-i",
                    "%reconstruction_dir%" + FOLDER_DELIM + "sfm_data.bin",
                    "-o",
                    "%reconstruction_dir%" + FOLDER_DELIM + "colorized.ply",
                ],
            ],
            [
                ...
                [
                    ...
                    "%matches_dir%" + FOLDER_DELIM + "matches.f.bin",
                    "-o",
                    "%reconstruction_dir%" + FOLDER_DELIM + "robust.bin",
                ],
            ],
            [
                ...
                [
                    ...
                    "%reconstruction_dir%" + FOLDER_DELIM + "robust.bin",
                    "-o",
                    "%reconstruction_dir%" + FOLDER_DELIM + "robust_colorized.ply",
                ],
            ],
            [
            ...
            [
                ...
                [
                    ...
                    "%reconstruction_dir%" + FOLDER_DELIM + "sfm_data.bin",
                    "-o",
                    "%mvs_dir%" + FOLDER_DELIM + "scene.mvs",
                    "-d",
                    "%mvs_dir%" + FOLDER_DELIM + "images",
                ],
            ],
            [
                ...
                [
                    "feature_extractor",
                    "--database_path",
                    "%matches_dir%" + FOLDER_DELIM + "database.db",
                    "--image_path",
                    "%input_dir%",
            ...
            [
                ...
                [
                    "model_aligner",
                    "--input_path",
                    "%reconstruction_dir%" + FOLDER_DELIM + "0",
                    "--database_path",
                    "%matches_dir%" + FOLDER_DELIM + "database.db",
                    "--output_path",
                    "%reconstruction_dir%" + FOLDER_DELIM + "0",
                    ...
                    "--alignment_type=enu",
                    "--transform_path",
                    "%reconstruction_dir%" + FOLDER_DELIM + "transform.txt",
                ],
            ],
            [
                ...
                [
                    ...
                    "%reconstruction_dir%" + FOLDER_DELIM + "0",
                    "--output_path",
                    "%reconstruction_dir%" + FOLDER_DELIM + "dense",
                    "--output_type",
                    "COLMAP",
                ],
            ],
...
if 4 in CONF.steps:  # GeometricFilter
    if 6 in CONF.steps:  # GlobalReconstruction
        ...
        STEPS.replace_opt(
            4, FOLDER_DELIM + "matches.f.bin", FOLDER_DELIM + "matches.e.bin"
        )
...
if 21 in CONF.steps:  # TextureMesh
    if 20 not in CONF.steps:  # RefineMesh
        ...
        STEPS.replace_opt(
            21, "scene_dense_mesh_refine_texture.mvs", "scene_dense_mesh_texture.mvs"
        )
    ...
    if not DEBUG:
        ...
        try:
            ...
            if cstep == 15 and "--ref_is_gps=1" in STEPS[cstep].opt:
                printout(
                    "# Retry COLMAP model-aligner step using plane alignment instead of GPS",
                    effect=INVERSE,
                )
