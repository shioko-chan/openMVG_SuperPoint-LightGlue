...
namespace openMVG
{
    namespace features
    {
        ...
        using SuperPoint_Regions = Scalar_Regions<SIOPointFeature, float, 256>;
...
EIGEN_DEFINE_STL_VECTOR_SPECIALIZATION_INITIALIZER_LIST(openMVG::features::SuperPoint_Regions)
